...
<html>
    ...
    <p>Na aba <b><a href="https://brumedezembro.github.io/biblitrans/map.html" target="_blank">Mapa</a></b>, os items do acervo são divididos por localização, com base no seu formato: "Teses e dissertação" são localizadas nas universidades de origem; "Artigos em periódicos" na universidade de publicação do periódico; "Livros" com base na localização da editora que publica o livro. Esse processo é automatizado, e pode conter pequenos erros na localização exata. Destacamos que a aba não leva em consideração a origem da autoria da pesquisa, ou a localização geográfica da obra em si.
